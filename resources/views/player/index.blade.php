<x-layout>
  ...
  <div id="master-player"
    class="pb-safe fixed bottom-0 left-0 right-0 z-50 translate-y-full transform border-t border-zinc-800 bg-zinc-900/95 backdrop-blur-xl transition-transform duration-300 ease-out">
    ...
    <div class="mx-auto max-w-4xl px-4 py-3 sm:px-6">
      <div class="flex flex-col gap-3 sm:grid sm:grid-cols-12 sm:items-center sm:gap-4">
        ...
        <div class="flex min-w-0 items-center gap-3 sm:col-span-3">
          <div class="flex min-w-0 flex-col">
            <span id="active-title" class="truncate text-sm font-medium text-white sm:text-base">Title</span>
        ...
        <div class="flex flex-col items-center gap-2 sm:col-span-6">
          <div class="flex w-full items-center justify-between px-4 sm:justify-center sm:gap-6 sm:px-0">
            ...
            <button id="master-shuffle" class="text-zinc-400 transition-colors hover:text-white sm:order-1"
            ...
            <div class="flex items-center gap-6 sm:order-2 sm:gap-5">
              ...
              <button id="master-play-btn"
                class="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500 text-black transition-all hover:scale-105 active:scale-95 sm:h-10 sm:w-10">
                <svg id="m-play-icon" class="h-6 w-6 fill-current sm:h-5 sm:w-5" viewBox="0 0 24 24">
                  <path d="M8 5v14l11-7z" />
                </svg>
                <svg id="m-pause-icon" class="hidden h-6 w-6 fill-current sm:h-5 sm:w-5" viewBox="0 0 24 24">
            ...
            <button id="master-repeat" class="text-zinc-400 transition-colors hover:text-white sm:order-3"
              title="Toggle Repeat">
              <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="hidden items-center justify-end gap-2 sm:col-span-3 sm:flex">
